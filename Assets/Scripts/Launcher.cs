...
public class Launcher : MonoBehaviour
{
    ...
    private void Launch()
    {
        ...
        PlayerPrefs.SetString("MRAV", MRAV.isOn.ToString());
        PlayerPrefs.SetString("cellView", cellView.isOn.ToString());
        if (PlayerPrefs.GetString("MRAV") == "True")
        {

            VRSettings.enabled = false;
        }
        if (PlayerPrefs.GetString("MRAV") == "False" & VRSettings.enabled == false)
        {
            VRSettings.enabled = true;
        }
        string ff = "";
        ...
        //launch MoleRift
        if (PlayerPrefs.GetString("cellView") == "True")
        {
            Application.LoadLevel("hiv+blood");
        }
        else if(PlayerPrefs.GetString("cellView") == "False")
        {
